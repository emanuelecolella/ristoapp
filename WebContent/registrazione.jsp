...
<%@ page import="java.util.ArrayList" %> 
  ...
  <title>Risto APP | Registrazione</title>
...
%> COMPARIVA H1 CON ERRORI PER ESTESO --%>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Risto</b>APP</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Completa la registrazione per accedere al portale</p>
    ...
    <div class="form-group has-feedback">
        ...
        <span class="asterischi"><%=asterischi[0] %></span>
      </div>
      
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Cognome" name="cognome">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
        <span class="asterischi"><%=asterischi[1] %></span>
      </div>
      
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" name="username">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
        <span class="asterischi"><%=asterischi[2] %></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name="password">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        <span class="asterischi"><%=asterischi[3] %></span>
      </div>
      <div class="row">
    ...
    <a href="login.jsp" class="text-center">Sei già registrato? Clicca qui!</a>
