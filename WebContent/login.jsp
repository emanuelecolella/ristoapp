...
<div class="login-box">
  <div class="login-logo">
    <a href="dashboard/index2.html"><b>Risto</b>APP</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
	<c:choose>
		<c:when test="${messaggio!=null}">
			<h1 style="font-size: 20px;font-weight: bold;margin: 0 0 10px 0;color: red;text-transform: uppercase;">${messaggio}</h1>
		</c:when>
	</c:choose>
	
	<p class="login-box-msg">Effettua l'accesso per iniziare la tua sessione</p>
    ...
    <a href="registrazione.jsp" class="text-center">Non sei registrato? Clicca qui!</a>
